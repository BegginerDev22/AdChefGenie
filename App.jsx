                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {POPULAR_RECIPES.map(recipe => (
                        <div 
                            ...
                            className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-md transition-all cursor-pointer flex flex-col group tilt-card"
                        >
