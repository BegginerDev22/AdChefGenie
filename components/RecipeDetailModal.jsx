...
const RecipeDetailModal = ({ recipe, isOpen, onClose, isSaved, onToggleSave, onShowToast }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl h-[90vh] overflow-hidden flex flex-col min-h-0 transform transition-all animate-[fadeIn_0.2s_ease-out] shimmer-border card-3d">
        ...
        <div className="relative h-48 sm:h-64 bg-orange-100 dark:bg-gray-800 flex-shrink-0 card-3d">
          ...
          {recipe.cuisine && (
              <div className="absolute top-4 left-4 z-10">
                   <span className={`${cuisineColor} backdrop-blur-md px-3 py-1.5 rounded-full text-xs font-bold text-white shadow-md flex items-center gap-1.5 border border-white/20`}>
                      🌍 {recipe.cuisine}
                   </span>
              </div>
          )}
        ...
        <div className="flex-1 min-h-0 overflow-y-scroll p-6 pt-10 space-y-6 custom-scrollbar modal-scroll-area">
